const rulesPopupComponent = {
    getComponent() {
        return `
        <div id = "rules-popup-cover">
            <div id = "rules-popup">
                <span id = "rules-popup-x">X</span>
                <h6>개인정보 수집 및 이용에 대한 안내</h6>
                <div id = "rules-popup-content">
                    개인정보 수집 및 이용에 대한 안내
                    <br><br>
                ...
                <div id = "rules-popup-agree">
                    <button id = "rules-popup-agree-btn">동의</button>
                </div>
            </div>
        </div>
        `
